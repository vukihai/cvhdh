...
{
	public class AddressEntityFormTileEntity : BaseEntity
	{
		...
		public AddressEntityFormTileEntity()
		{
			EntityName = "AddressEntityFormTileEntity";
			InitialiseReferences();
		}

		public AddressEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<AddressEntityFormTileEntity>()
		...
		public static AddressEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<AddressEntityFormTileEntity>().entity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new AddressEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static AddressEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var addressEntityFormTileEntity = new AddressEntityFormTileEntity
			{
			};
			addressEntityFormTileEntity.PopulateAttributes();
