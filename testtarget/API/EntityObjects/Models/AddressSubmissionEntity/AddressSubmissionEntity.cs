...
{
	public class AddressSubmissionEntity : BaseEntity
	{


		public AddressSubmissionEntity()
		{
			EntityName = "AddressSubmissionEntity";
			InitialiseReferences();
		}

		public AddressSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<AddressSubmissionEntity>()
		...
		public static AddressSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<AddressSubmissionEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static AddressSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var addressSubmissionEntity = new AddressSubmissionEntity
			{
			};
			addressSubmissionEntity.PopulateAttributes();
