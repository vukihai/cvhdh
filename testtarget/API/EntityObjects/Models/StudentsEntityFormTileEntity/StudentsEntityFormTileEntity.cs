...
{
	public class StudentsEntityFormTileEntity : BaseEntity
	{
		...
		public StudentsEntityFormTileEntity()
		{
			EntityName = "StudentsEntityFormTileEntity";
			InitialiseReferences();
		}

		public StudentsEntityFormTileEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<StudentsEntityFormTileEntity>()
		...
		public static StudentsEntityFormTileEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<StudentsEntityFormTileEntity>().entity;
		}
		...
		private void SetValidEntityAssociations()
		{
			...
			FormId = new StudentsEntity(ConfigureOptions.CREATE_ATTRIBUTES_AND_REFERENCES).Save();
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static StudentsEntityFormTileEntity GetValidEntity(string fixedStrValue = null)
		{
			var studentsEntityFormTileEntity = new StudentsEntityFormTileEntity
			{
			};
			studentsEntityFormTileEntity.PopulateAttributes();
