...
{
	public class StudentsSubmissionEntity : BaseEntity
	{


		public StudentsSubmissionEntity()
		{
			EntityName = "StudentsSubmissionEntity";
			InitialiseReferences();
		}

		public StudentsSubmissionEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseReferences();
		}
		...
		{
			return GetInvalidEntities<StudentsSubmissionEntity>()
		...
		public static StudentsSubmissionEntity GetEntity(bool isValid, string fixedValue = null)
		{
			if (isValid && !string.IsNullOrEmpty(fixedValue))
			{
				return GetValidEntity(fixedValue);
			}
			return isValid ? GetValidEntity() : GetInvalidEntity<StudentsSubmissionEntity>().entity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static StudentsSubmissionEntity GetValidEntity(string fixedStrValue = null)
		{
			var studentsSubmissionEntity = new StudentsSubmissionEntity
			{
			};
			studentsSubmissionEntity.PopulateAttributes();
