...
namespace APITests.Extensions
{
	public static class PropertyInfoExtensions
	{
		...
		public static CustomAttributeData GetAttribute(this PropertyInfo propertyInfo, Type attributeType)
		{
			return propertyInfo.CustomAttributes.FirstOrDefault(x => x.AttributeType == attributeType);
		}
