...
{
	public class AttributeTextField : Component
	{
		...
		public AttributeTextField(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
