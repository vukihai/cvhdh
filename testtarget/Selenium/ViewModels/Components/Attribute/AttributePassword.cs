...
{
	public class AttributePassword : Component
	{
		...
		public AttributePassword(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
