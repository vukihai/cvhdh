...
{
	public class AddressSubmissionEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AddressSubmissionEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
