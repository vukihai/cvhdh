...
{
	public class AddressEntityFormTileEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AddressEntityFormTileEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
