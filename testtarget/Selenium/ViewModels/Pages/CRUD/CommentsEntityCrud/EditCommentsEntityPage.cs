...
{
	public class EditCommentsEntityPage : CommentsEntityAttributeCollection
	{
		...
		public EditCommentsEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
