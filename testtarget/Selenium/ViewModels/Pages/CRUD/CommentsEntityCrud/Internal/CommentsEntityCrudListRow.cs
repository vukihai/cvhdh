...
{
	public class CommentsEntityCrudListRow : Component, ICrudListRow
	{
		...
		public CommentsEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
