...
{
	public class CreateCommentsEntityPage : CommentsEntityAttributeCollection
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/commentsEntity/create";
		public CrudCreateButtons ActionButtons => new(ContextConfiguration);
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public CreateCommentsEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
		...
		public void SetValues(CommentsEntity commentsEntity)
		{
			CommentDate.Value = commentsEntity.CommentDate.GetValueOrDefault();
			CommentDescription.Value = commentsEntity.CommentDescription;
			AssessmentsId.Value = commentsEntity.AssessmentsId == null ? string.Empty : commentsEntity.AssessmentsId.ToString();
		}
		// % protected region % [Override set values here] end

		// % protected region % [Override get values here] off begin
		public CommentsEntity GetValues()
		{
			...
			if (Guid.TryParse(AssessmentsId.Value, out var assessmentsId)) {
				commentsEntity.AssessmentsId = assessmentsId;
			}
