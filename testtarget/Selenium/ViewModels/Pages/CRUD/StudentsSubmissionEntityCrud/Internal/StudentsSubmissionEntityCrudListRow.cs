...
{
	public class StudentsSubmissionEntityCrudListRow : Component, ICrudListRow
	{
		...
		public StudentsSubmissionEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
