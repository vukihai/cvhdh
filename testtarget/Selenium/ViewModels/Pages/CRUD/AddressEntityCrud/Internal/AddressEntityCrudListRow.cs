...
{
	public class AddressEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AddressEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
