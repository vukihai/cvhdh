...
{
	public class EditAddressEntityPage : AddressEntityAttributeCollection
	{
		...
		public EditAddressEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
