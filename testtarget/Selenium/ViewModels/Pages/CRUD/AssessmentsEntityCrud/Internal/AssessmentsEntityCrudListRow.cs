...
{
	public class AssessmentsEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AssessmentsEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
