...
{
	public class AchievementsSubmissionEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AchievementsSubmissionEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
