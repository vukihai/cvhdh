...
{
	public class ReadAchievementsEntityFormTileEntityPage : AchievementsEntityFormTileEntityAttributeCollection
	{
		// % protected region % [Override class properties here] off begin
		public string Url => ContextConfiguration.BaseUrl + "/admin/achievementsEntityFormTileEntity/view";
		// % protected region % [Override class properties here] end

		// % protected region % [Override constructor here] off begin
		public ReadAchievementsEntityFormTileEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
