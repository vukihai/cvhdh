...
{
	public class AssessmentNotesEntityCrudListRow : Component, ICrudListRow
	{
		...
		public AssessmentNotesEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
