...
{
	public class EditStudentsEntityPage : StudentsEntityAttributeCollection
	{
		...
		public EditStudentsEntityPage(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
