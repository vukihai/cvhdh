...
{
	public class StudentsEntityCrudListRow : Component, ICrudListRow
	{
		...
		public StudentsEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
