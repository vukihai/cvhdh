...
{
	public class StaffEntityAttributeCollection : Page
	{
		...
		public AttributeEnumCombobox Role => new(By.CssSelector("div.role"), ContextConfiguration);
		...
		public StaffEntityAttributeCollection(ContextConfiguration contextConfiguration) : base(contextConfiguration)
		{
		}
