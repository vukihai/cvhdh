...
{
	public class StaffEntityCrudListRow : Component, ICrudListRow
	{
		...
		public StaffEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
