...
{
	public class StudentsEntityFormTileEntityCrudListRow : Component, ICrudListRow
	{
		...
		public StudentsEntityFormTileEntityCrudListRow(By selector, ContextConfiguration contextConfiguration) : base(selector, contextConfiguration)
		{
		}
