...
Feature: Delete all AchievementsEntity on all pages
# % protected region % [Override feature properties here] end
	@AchievementsEntity
	Scenario: Delete all AchievementsEntity on all pages
	Given I have 15 valid AchievementsEntity entities
