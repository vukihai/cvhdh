...
Feature: Delete all AssessmentNotesEntity on all pages
# % protected region % [Override feature properties here] end
	@AssessmentNotesEntity
	Scenario: Delete all AssessmentNotesEntity on all pages
	Given I have 15 valid AssessmentNotesEntity entities
