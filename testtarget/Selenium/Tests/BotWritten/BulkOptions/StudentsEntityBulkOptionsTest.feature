...
Feature: StudentsEntity Bulk Option Selection
...
@StudentsEntity
Scenario: Select all StudentsEntitys on current page
...
@StudentsEntity
Scenario: I attempt to select all StudentsEntitys on all pages
Given I login to the site as a user
And I navigate to the StudentsEntity backend page
When I select all entities on current page
