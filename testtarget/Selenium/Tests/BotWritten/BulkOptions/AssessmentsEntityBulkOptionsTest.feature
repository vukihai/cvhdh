...
Feature: AssessmentsEntity Bulk Option Selection
...
@AssessmentsEntity
Scenario: Select all AssessmentsEntitys on current page
...
@AssessmentsEntity
Scenario: I attempt to select all AssessmentsEntitys on all pages
Given I login to the site as a user
And I navigate to the AssessmentsEntity backend page
When I select all entities on current page
