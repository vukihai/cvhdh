...
Feature: CommentsEntity Bulk Option Selection
...
@CommentsEntity
Scenario: Select all CommentsEntitys on current page
...
@CommentsEntity
Scenario: I attempt to select all CommentsEntitys on all pages
Given I login to the site as a user
And I navigate to the CommentsEntity backend page
When I select all entities on current page
