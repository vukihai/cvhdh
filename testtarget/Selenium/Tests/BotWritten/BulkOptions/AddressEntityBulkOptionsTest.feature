...
Feature: AddressEntity Bulk Option Selection
...
@AddressEntity
Scenario: Select all AddressEntitys on current page
...
@AddressEntity
Scenario: I attempt to select all AddressEntitys on all pages
Given I login to the site as a user
And I navigate to the AddressEntity backend page
When I select all entities on current page
