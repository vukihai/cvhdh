...
Feature: AchievementsEntity Bulk Option Selection
...
@AchievementsEntity
Scenario: Select all AchievementsEntitys on current page
...
@AchievementsEntity
Scenario: I attempt to select all AchievementsEntitys on all pages
Given I login to the site as a user
And I navigate to the AchievementsEntity backend page
When I select all entities on current page
