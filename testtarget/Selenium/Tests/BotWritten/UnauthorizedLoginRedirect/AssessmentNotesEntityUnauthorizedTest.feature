...
Feature: Unauthorized AssessmentNotesEntity Redirect
# % protected region % [Override feature properties here] end

@AssessmentNotesEntity
Scenario: Unauthorized AssessmentNotesEntity Redirect
Given I am logged out of the site
And I navigate to the AssessmentNotesEntity backend page
Then I assert that I am redirected from AssessmentNotesEntity to login page
