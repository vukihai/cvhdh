...
Feature: Unauthorized AddressEntity Redirect
# % protected region % [Override feature properties here] end

@AddressEntity
Scenario: Unauthorized AddressEntity Redirect
Given I am logged out of the site
And I navigate to the AddressEntity backend page
Then I assert that I am redirected from AddressEntity to login page
