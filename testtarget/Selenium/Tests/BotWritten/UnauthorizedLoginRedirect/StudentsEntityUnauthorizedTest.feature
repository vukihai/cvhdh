...
Feature: Unauthorized StudentsEntity Redirect
# % protected region % [Override feature properties here] end

@StudentsEntity
Scenario: Unauthorized StudentsEntity Redirect
Given I am logged out of the site
And I navigate to the StudentsEntity backend page
Then I assert that I am redirected from StudentsEntity to login page
