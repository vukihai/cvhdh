...
@BotWritten @pages
Feature: EditArchivementPage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@EditArchivementPage
Scenario: Check contents of EditArchivementPage page
Given I login to the site as a user
And I navigate to the EditArchivementPage frontend page
Then The contents of the EditArchivementPage is correct
