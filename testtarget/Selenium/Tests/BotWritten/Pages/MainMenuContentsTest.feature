...
@BotWritten @pages
Feature: MainMenuPage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@MainMenuPage
Scenario: Check contents of MainMenuPage page
Given I login to the site as a user
And I navigate to the MainMenuPage frontend page
Then The contents of the MainMenuPage is correct
