...
@BotWritten @pages
Feature: FormEditStudentPage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@FormEditStudentPage
Scenario: Check contents of FormEditStudentPage page
Given I login to the site as a user
And I navigate to the FormEditStudentPage frontend page
Then The contents of the FormEditStudentPage is correct
