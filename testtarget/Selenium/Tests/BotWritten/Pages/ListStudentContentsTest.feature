...
@BotWritten @pages
Feature: ListStudentPage Contents Feature
# % protected region % [Override feature properties here] end

# % protected region % [Override test contents here] off begin
@ListStudentPage
Scenario: Check contents of ListStudentPage page
Given I login to the site as a user
And I navigate to the ListStudentPage frontend page
Then The contents of the ListStudentPage is correct
