...
@BotWritten @Filter
Feature: CommentsEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@CommentsEntity
Scenario: CommentsEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid CommentsEntity entities
And I navigate to the CommentsEntity backend page
When I click the filter Button on the CommentsEntity page
