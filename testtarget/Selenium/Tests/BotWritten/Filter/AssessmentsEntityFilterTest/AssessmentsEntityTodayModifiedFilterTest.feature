...
@BotWritten @Filter
Feature: AssessmentsEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@AssessmentsEntity
Scenario: AssessmentsEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid AssessmentsEntity entities
And I navigate to the AssessmentsEntity backend page
When I click the filter Button on the AssessmentsEntity page
