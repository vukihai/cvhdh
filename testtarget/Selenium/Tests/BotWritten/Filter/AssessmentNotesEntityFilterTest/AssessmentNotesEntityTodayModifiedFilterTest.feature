...
@BotWritten @Filter
Feature: AssessmentNotesEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@AssessmentNotesEntity
Scenario: AssessmentNotesEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid AssessmentNotesEntity entities
And I navigate to the AssessmentNotesEntity backend page
When I click the filter Button on the AssessmentNotesEntity page
