...
@BotWritten @Filter
Feature: AddressEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@AddressEntity
Scenario: AddressEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid AddressEntity entities
And I navigate to the AddressEntity backend page
When I click the filter Button on the AddressEntity page
