...
@BotWritten @Filter
Feature: StudentsEntity filtered by today's modified Feature
# % protected region % [Override feature properties here] end

@StudentsEntity
Scenario: StudentsEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid StudentsEntity entities
And I navigate to the StudentsEntity backend page
When I click the filter Button on the StudentsEntity page
