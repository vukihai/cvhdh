...
@BotWritten @view
Feature: Admin Submenu StaffEntity Feature
# % protected region % [Override feature properties here] end
	@StaffEntity
	Scenario: I attempt to navigate to the StaffEntity entity page
	...
	And I click the Staff admin submenu
	Then I assert that I am on the Staff Entity backend page
