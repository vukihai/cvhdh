...
Feature: Admin Submenu AssessmentNotesEntity
# % protected region % [Override feature properties here] end

	@AssessmentNotesEntity
	Scenario: Admin Submenu AssessmentNotesEntity
	...
	And I click the Assessment Notes admin submenu
	Then I assert that I am on the Assessment Notes Entity backend page