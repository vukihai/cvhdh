...
Feature: Admin Submenu AssessmentsEntity
# % protected region % [Override feature properties here] end

	@AssessmentsEntity
	Scenario: Admin Submenu AssessmentsEntity
	...
	And I click the Assessments admin submenu
	Then I assert that I am on the Assessments Entity backend page