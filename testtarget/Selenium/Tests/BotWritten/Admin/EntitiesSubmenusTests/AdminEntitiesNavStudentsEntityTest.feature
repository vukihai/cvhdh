...
Feature: Admin Submenu StudentsEntity
# % protected region % [Override feature properties here] end

	@StudentsEntity
	Scenario: Admin Submenu StudentsEntity
	...
	And I click the Students admin submenu
	Then I assert that I am on the Students Entity backend page