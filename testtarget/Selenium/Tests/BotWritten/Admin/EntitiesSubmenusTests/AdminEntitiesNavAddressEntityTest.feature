...
Feature: Admin Submenu AddressEntity
# % protected region % [Override feature properties here] end

	@AddressEntity
	Scenario: Admin Submenu AddressEntity
	...
	And I click the Address admin submenu
	Then I assert that I am on the Address Entity backend page