...
Feature: Admin Submenu CommentsEntity
# % protected region % [Override feature properties here] end

	@CommentsEntity
	Scenario: Admin Submenu CommentsEntity
	...
	And I click the Comments admin submenu
	Then I assert that I am on the Comments Entity backend page