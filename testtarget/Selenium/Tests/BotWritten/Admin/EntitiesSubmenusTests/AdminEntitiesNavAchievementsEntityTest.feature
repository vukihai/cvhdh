...
Feature: Admin Submenu AchievementsEntity
# % protected region % [Override feature properties here] end

	@AchievementsEntity
	Scenario: Admin Submenu AchievementsEntity
	...
	And I click the Achievements admin submenu
	Then I assert that I am on the Achievements Entity backend page