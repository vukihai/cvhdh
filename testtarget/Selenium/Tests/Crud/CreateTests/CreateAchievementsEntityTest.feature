...
@BotWritten @create
Feature: Create AchievementsEntity
# % protected region % [Override feature properties here] end
# % protected region % [Override test content here] off begin
	@AchievementsEntity
	Scenario: Create AchievementsEntity
	Given I login to the site as a user
	And I navigate to the AchievementsEntity admin crud page
	And I click to create a AchievementsEntity
	When I create a valid AchievementsEntity
	Then I assert that I am on the AchievementsEntity admin crud page
	Then I assert a toaster alert is displayed with the message: Successfully added Achievements
