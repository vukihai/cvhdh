...
namespace SeleniumTests.PageObjects.BotWritten.UserPageObjects
{
	...
	{
		public IWebElement AchievementsSubmissionEntityDropdownOption => FindElementExt("AchievementsSubmissionEntityDropdownOption");
		public IWebElement AddressSubmissionEntityDropdownOption => FindElementExt("AddressSubmissionEntityDropdownOption");
		public IWebElement StudentsSubmissionEntityDropdownOption => FindElementExt("StudentsSubmissionEntityDropdownOption");
		...
		{
			selectorDict.Add("AchievementsSubmissionEntityDropdownOption", (selector: "//div[contains(@data-id, 'AchievementsSubmissionEntity')]", type: SelectorType.XPath));
			selectorDict.Add("AddressSubmissionEntityDropdownOption", (selector: "//div[contains(@data-id, 'AddressSubmissionEntity')]", type: SelectorType.XPath));
			selectorDict.Add("StudentsSubmissionEntityDropdownOption", (selector: "//div[contains(@data-id, 'StudentsSubmissionEntity')]", type: SelectorType.XPath));
