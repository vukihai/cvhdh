...
{
	public class EditArchivementPage : UIModeledPage
	{
		// % protected region % [Override class properties here] off begin
		public override string Url => baseUrl + "/editarchivement";
		private const string RootSelector = "//div[@class='body-content']";
		private By HeadingComponentBy => By.XPath($"{RootSelector}//h1[text()='Edit archivement']");
		private By ParagraphBy => By.XPath($"{RootSelector}//p[text()='this page use to edit archivement of student']");
		private By FormComponentBy => By.XPath($"{RootSelector}//div[@class = 'form-submission-tile']");
		// % protected region % [Override class properties here] end
		// % protected region % [Override constructor here] off begin
		public EditArchivementPage(ContextConfiguration currentContext) : base(currentContext)
		{
		}
