...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class StudentsEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly StudentsEntityFormTileEntity _studentsEntityFormTileEntity;
		...
		public StudentsEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, StudentsEntityFormTileEntity studentsEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_studentsEntityFormTileEntity = studentsEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_studentsEntityFormTileEntity.Tile);
