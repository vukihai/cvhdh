...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class AddressEntityFormTileEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly AddressEntityFormTileEntity _addressEntityFormTileEntity;
		...
		public AddressEntityFormTileEntityDetailSection(ContextConfiguration contextConfiguration, AddressEntityFormTileEntity addressEntityFormTileEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_addressEntityFormTileEntity = addressEntityFormTileEntity;
		...
		public void Apply()
		{
			...
			SetTile(_addressEntityFormTileEntity.Tile);
