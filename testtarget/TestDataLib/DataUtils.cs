	...
	public static class DataUtils
	{
		...
		public static string RandString(int length = 10, CharType charType = CharType.WORDY_ONLY)
		{
			...
			switch (charType)
			{
				...
				case CharType.ALPHANUMERIC_ONLY:
					return new string(Enumerable.Repeat(_chars + _nums, length).Select(s => s[RandInt(0, s.Length - 1)]).ToArray());
				case CharType.NUMERIC_ONLY:
					return new string(Enumerable.Repeat(_nums, length).Select(s => s[RandInt(0, s.Length - 1)]).ToArray());
		...
		/// <summary>
		/// Return a valid url that has been randomly generated
		/// </summary>
		/// <returns> A valid url that has been randomly generated </returns>
		public static string RandUrl()
		{
			var secondLevelDomain = RandString(10, CharType.ALPHABETIC_ONLY);
			var topLevelDomain = RandString(2, CharType.ALPHABETIC_ONLY);
			return $"{secondLevelDomain}.{topLevelDomain.ToLower()}";
		}
		/// <summary>
		/// Return a valid alpha numeric string that has been randomly generated
		/// </summary>
		/// <returns> A valid alpha numeric string that has been randomly generated </returns>
		public static string RandAlphanumericString(int minLength = 10, int maxLength = 10)
		{
			return RandString(RandInt(minLength, maxLength), CharType.ALPHANUMERIC_ONLY);
		}
		/// <summary>
		/// Return a valid numeric string that has been randomly generated
		/// </summary>
		/// <returns> A valid numeric string that has been randomly generated </returns>
		public static string RandNumericString(int minLength = 10, int maxLength = 10)
		{
			return RandString(RandInt(minLength, maxLength), CharType.NUMERIC_ONLY);
		}
