		...
		public static TheoryData<IAbstractModel, bool, string> VisitorsReadSecurityData 
		{
			get
			{
				var data = new TheoryData<IAbstractModel, bool, string>
				{
					...
					{new AchievementsEntity(), true, "Visitors"},
					{new AddressEntity(), true, "Visitors"},
					{new StudentsEntity(), true, "Visitors"},
					{new AssessmentNotesEntity(), true, "Visitors"},
					{new AssessmentsEntity(), true, "Visitors"},
					{new CommentsEntity(), true, "Visitors"},
					{new AchievementsSubmissionEntity(), true, "Visitors"},
					{new AddressSubmissionEntity(), true, "Visitors"},
					{new StudentsSubmissionEntity(), true, "Visitors"},
					{new AchievementsEntityFormTileEntity(), true, "Visitors"},
					{new AddressEntityFormTileEntity(), true, "Visitors"},
					{new StudentsEntityFormTileEntity(), true, "Visitors"},
