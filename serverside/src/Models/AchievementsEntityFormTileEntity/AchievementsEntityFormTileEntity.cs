...
namespace Firstapp2257.Models {
	...
	// % protected region % [Modify class declaration here] end
	{
		...
		[EntityForeignKey("Form", "FormPages", true, typeof(AchievementsEntity))]
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<AchievementsEntityFormTileEntity>().ToList();
