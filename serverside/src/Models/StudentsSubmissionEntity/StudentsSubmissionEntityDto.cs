...
namespace Firstapp2257.Models
{
	...
	/// </summary>
	public class StudentsSubmissionEntityDto : ModelDto<StudentsSubmissionEntity>
	{
		...
		public StudentsSubmissionEntityDto(StudentsSubmissionEntity model)
		{
			LoadModelData(model);
		...
		public StudentsSubmissionEntityDto()
		{
		...
		public override ModelDto<StudentsSubmissionEntity> LoadModelData(StudentsSubmissionEntity model)
		{
			Id = model.Id;
