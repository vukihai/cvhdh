...
namespace Firstapp2257.Models
{
	...
	/// </summary>
	public class AchievementsEntityFormVersionType : ObjectGraphType<AchievementsEntityFormVersion>
	{
		public AchievementsEntityFormVersionType()
		{
			Description = @"The form versions for the Achievements Entity form behaviour";
			...
			Field<AchievementsEntityType, AchievementsEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid?, AchievementsEntity>(
						"GetPublishedFormForAchievementsEntityFromVersion",
						async keys =>
						{
			...
			Field<AchievementsEntityType, AchievementsEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var accessor = graphQlContext.ServiceProvider.GetRequiredService<IDataLoaderContextAccessor>();
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, AchievementsEntity>(
						"GetFormForAchievementsEntityFormVersion",
						async keys =>
						{
							var results = await QueryHelpers.BuildQueryResolver<AchievementsEntity>(
								context,
			...
			Field<ListGraphType<AchievementsSubmissionEntityType>, IEnumerable<AchievementsSubmissionEntity>>()
				...
				.ResolveAsync(async context =>
				{
					var graphQlContext = (Firstapp2257GraphQlContext) context.UserContext;
					var accessor = graphQlContext.ServiceProvider.GetRequiredService<IDataLoaderContextAccessor>();
					var loader = accessor.Context.GetOrAddCollectionBatchLoader<Guid, AchievementsSubmissionEntity>(
						"GetFormSubmissionsForAchievementsEntityFormVersion",
						async keys =>
						{
							var args = new CommonArguments(context);
							var query = QueryHelpers.CreateResolveFunction<AchievementsSubmissionEntity>(context, new ReadOptions {DisableAudit = true});
	...
	/// </summary>
	public class AchievementsEntityFormVersionInputType : InputObjectGraphType<AchievementsEntityFormVersion>
	{
		public AchievementsEntityFormVersionInputType()
		{
			Name = "AchievementsEntityFormVersionInput";
			Description = "The input object for adding a new AchievementsEntityFormVersion";
			...
			Field<ListGraphType<AchievementsSubmissionEntityInputType>>("FormSubmissions").Description = @"The submissions for this form version";
