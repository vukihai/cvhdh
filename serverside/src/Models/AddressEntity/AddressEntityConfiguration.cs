...
namespace Firstapp2257.Models {
	public class AddressEntityConfiguration : IEntityTypeConfiguration<AddressEntity>
	{
		public void Configure(EntityTypeBuilder<AddressEntity> builder)
		{
			...
			// % protected region % [Override Staffss Address configuration here] off begin
			builder
				.HasMany(e => e.Staffss)
				.WithOne(e => e.Address)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override Staffss Address configuration here] end

			// % protected region % [Override Studentss Address configuration here] off begin
			builder
				.HasMany(e => e.Studentss)
				.WithOne(e => e.Address)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override Studentss Address configuration here] end
