...
namespace Firstapp2257.Models {
	...
	// % protected region % [Modify class declaration here] end
	{
		...
		// % protected region % [Customise Assessments here] off begin
		/// <summary>
		/// Outgoing one to many reference
		/// </summary>
		/// <see cref="Firstapp2257.Models.AssessmentsEntity"/>
		public Guid? AssessmentsId { get; set; }
		[EntityForeignKey("Assessments", "AssessmentNotess", false, typeof(AssessmentsEntity))]
		public AssessmentsEntity Assessments { get; set; }
		// % protected region % [Customise Assessments here] end

		// % protected region % [Customise Staff here] off begin
		/// <summary>
		/// Outgoing one to many reference
		/// </summary>
		/// <see cref="Firstapp2257.Models.StaffEntity"/>
		public Guid? StaffId { get; set; }
		[EntityForeignKey("Staff", "AssessmentNotess", false, typeof(StaffEntity))]
		public StaffEntity Staff { get; set; }
		// % protected region % [Customise Staff here] end
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<AssessmentNotesEntity>().ToList();
