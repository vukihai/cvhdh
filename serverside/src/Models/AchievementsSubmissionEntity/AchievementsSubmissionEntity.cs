...
namespace Firstapp2257.Models {
	...
	// % protected region % [Modify class declaration here] end
	{
		...
		public AchievementsSubmissionEntity()
		{
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(AchievementsEntityFormVersion))]
		public AchievementsEntityFormVersion FormVersion { get; set; }
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<AchievementsSubmissionEntity>().ToList();
