...
{
	/// <summary>
	/// The Achievements submission form entity
	/// </summary>
	public class AchievementsSubmissionEntityDto : ModelDto<AchievementsSubmissionEntity>
	{
		...
		public AchievementsSubmissionEntityDto(AchievementsSubmissionEntity model)
		{
			LoadModelData(model);
		...
		public AchievementsSubmissionEntityDto()
		{
		...
		public override ModelDto<AchievementsSubmissionEntity> LoadModelData(AchievementsSubmissionEntity model)
		{
			Id = model.Id;
