...
namespace Firstapp2257.Models
{
	...
	/// </summary>
	public class AchievementsSubmissionEntityType : ObjectGraphType<AchievementsSubmissionEntity>
	{
		public AchievementsSubmissionEntityType()
		{
			Description = @"The Achievements submission form entity";
			...
			Field<AchievementsEntityFormVersionType, AchievementsEntityFormVersion>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, AchievementsEntityFormVersion>(
						"GetFormVersionForAchievementsSubmissionEntity",
						async keys =>
						{
	...
	/// </summary>
	public class AchievementsSubmissionEntityInputType : InputObjectGraphType<AchievementsSubmissionEntity>
	{
		public AchievementsSubmissionEntityInputType()
		{
			Name = "AchievementsSubmissionEntityInput";
			Description = "The input object for adding a new AchievementsSubmissionEntity";
