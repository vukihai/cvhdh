...
namespace Firstapp2257.Models
{
	...
	/// </summary>
	public class StudentsEntityFormTileEntityType : ObjectGraphType<StudentsEntityFormTileEntity>
	{
		public StudentsEntityFormTileEntityType()
		{
			...
			// GraphQL reference to entity StudentsEntity via reference Form
			Field<StudentsEntityType, StudentsEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, StudentsEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetFormForStudentsEntityFormTileEntity",
						async keys =>
						{
	...
	/// </summary>
	public class StudentsEntityFormTileEntityInputType : InputObjectGraphType<StudentsEntityFormTileEntity>
	{
		public StudentsEntityFormTileEntityInputType()
		{
			Name = "StudentsEntityFormTileEntityInput";
			Description = "The input object for adding a new StudentsEntityFormTileEntity";
			...
			Field<StudentsEntityInputType>("Form");
