...
namespace Firstapp2257.Models
{
	...
	/// </summary>
	public class CommentsEntityType : ObjectGraphType<CommentsEntity>
	{
		public CommentsEntityType()
		{
			...
			Field(o => o.CommentDate, type: typeof(DateTimeGraphType));
			Field(o => o.CommentDescription, type: typeof(StringGraphType));
			...
			Field<AssessmentsEntityType, AssessmentsEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid?, AssessmentsEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetAssessmentsForCommentsEntity",
						async keys =>
						{
	...
	/// </summary>
	public class CommentsEntityInputType : InputObjectGraphType<CommentsEntity>
	{
		public CommentsEntityInputType()
		{
			Name = "CommentsEntityInput";
			Description = "The input object for adding a new CommentsEntity";

			// Add entity fields
			Field<IdGraphType>("Id");
			Field<DateTimeGraphType>("Created");
			Field<DateTimeGraphType>("Modified");
			Field<DateTimeGraphType>("CommentDate");
			Field<StringGraphType>("CommentDescription");
