...
namespace Firstapp2257.Models {
	public class CommentsEntityConfiguration : IEntityTypeConfiguration<CommentsEntity>
	{
		public void Configure(EntityTypeBuilder<CommentsEntity> builder)
		{
			...
			// % protected region % [Override Assessments Commentss configuration here] off begin
			builder
				.HasOne(e => e.Assessments)
				.WithMany(e => e.Commentss)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override Assessments Commentss configuration here] end
