...
namespace Firstapp2257.Models {
	...
	public class CommentsEntity : IOwnerAbstractModel 
	// % protected region % [Modify class declaration here] end
	{
		...
		[EntityForeignKey("Assessments", "Commentss", false, typeof(AssessmentsEntity))]
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<CommentsEntity>().ToList();
