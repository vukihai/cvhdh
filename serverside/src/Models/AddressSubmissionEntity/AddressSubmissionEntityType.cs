...
namespace Firstapp2257.Models
{
	...
	/// </summary>
	public class AddressSubmissionEntityType : ObjectGraphType<AddressSubmissionEntity>
	{
		public AddressSubmissionEntityType()
		{
			Description = @"The Address submission form entity";
			...
			Field<AddressEntityFormVersionType, AddressEntityFormVersion>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, AddressEntityFormVersion>(
						"GetFormVersionForAddressSubmissionEntity",
						async keys =>
						{
	...
	/// </summary>
	public class AddressSubmissionEntityInputType : InputObjectGraphType<AddressSubmissionEntity>
	{
		public AddressSubmissionEntityInputType()
		{
			Name = "AddressSubmissionEntityInput";
			Description = "The input object for adding a new AddressSubmissionEntity";
