...
namespace Firstapp2257.Models {
	...
	// % protected region % [Modify class declaration here] end
	{
		...
		[EntityForeignKey("FormVersion", "FormSubmissions", false, typeof(AddressEntityFormVersion))]
		public AddressEntityFormVersion FormVersion { get; set; }
		...
		public async Task<int> CleanReference<T>(
			...
			{
			var modelList = models.Cast<AddressSubmissionEntity>().ToList();
