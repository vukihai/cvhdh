...
namespace Firstapp2257.Models
{
	...
	/// </summary>
	public class AddressEntityFormTileEntityType : ObjectGraphType<AddressEntityFormTileEntity>
	{
		public AddressEntityFormTileEntityType()
		{
			...
			// GraphQL reference to entity AddressEntity via reference Form
			Field<AddressEntityType, AddressEntity>()
				...
				.ResolveAsync(async context =>
				{
					...
					var loader = accessor.Context.GetOrAddBatchLoader<Guid, AddressEntity>(
						string.Join("-", context.ResponsePath.Where(x => x is string)) + "GetFormForAddressEntityFormTileEntity",
						async keys =>
						{
	...
	/// </summary>
	public class AddressEntityFormTileEntityInputType : InputObjectGraphType<AddressEntityFormTileEntity>
	{
		public AddressEntityFormTileEntityInputType()
		{
			Name = "AddressEntityFormTileEntityInput";
			Description = "The input object for adding a new AddressEntityFormTileEntity";
			...
			Field<AddressEntityInputType>("Form");
