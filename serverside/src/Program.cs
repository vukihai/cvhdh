		...
		public static IHostBuilder CreateWebHostBuilder(string[] args) =>
			Host.CreateDefaultBuilder(args)
				...
				.ConfigureAppConfiguration((builderContext, config) =>
				{
					...
					config.AddEnvironmentVariables("Firstapp2257_");
					config.AddEnvironmentVariables($"Firstapp2257_{env.EnvironmentName}_");
				...
				.UseSerilog((context, provider, loggerConfiguration) => 
				{
					loggerConfiguration
						...
						.Enrich.WithProperty("Application", "Firstapp2257")
						.WriteTo.Console();
				})
