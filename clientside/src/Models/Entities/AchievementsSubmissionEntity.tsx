...
import { VisitorsAchievementsSubmission } from 'Models/Security/Acl/VisitorsAchievementsSubmission';
import { StaffAchievementsSubmission } from 'Models/Security/Acl/StaffAchievementsSubmission';
...
export interface IAchievementsSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('AchievementsSubmissionEntity', 'Achievements Submission')
// % protected region % [Customise your entity metadata here] end
export default class AchievementsSubmissionEntity extends Model implements IAchievementsSubmissionEntityAttributes {
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as AchievementsSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IAchievementsSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IAchievementsSubmissionEntityAttributes>) {
...
CRUD(createdAttr)(AchievementsSubmissionEntity.prototype, 'created');
CRUD(modifiedAttr)(AchievementsSubmissionEntity.prototype, 'modified');
