...
export interface IAchievementsEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.AchievementsEntity | Models.IAchievementsEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('AchievementsEntityFormTileEntity', 'Achievements Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class AchievementsEntityFormTileEntity extends Model implements IAchievementsEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'AchievementsEntity',
	...
	public form: Models.AchievementsEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	// eslint-disable-next-line @typescript-eslint/no-useless-constructor
	constructor(attributes?: Partial<IAchievementsEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IAchievementsEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form !== undefined) {
				if (attributes.form === null) {
					...
					if (attributes.form instanceof Models.AchievementsEntity) {
						this.form = attributes.form;
						this.formId = attributes.form.id;
					} else {
						this.form = new Models.AchievementsEntity(attributes.form);
...
CRUD(createdAttr)(AchievementsEntityFormTileEntity.prototype, 'created');
CRUD(modifiedAttr)(AchievementsEntityFormTileEntity.prototype, 'modified');
