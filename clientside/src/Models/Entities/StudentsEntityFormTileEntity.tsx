...
export interface IStudentsEntityFormTileEntityAttributes extends IModelAttributes {
	tile: string;

	formId: string;
	form: Models.StudentsEntity | Models.IStudentsEntityAttributes;
	// % protected region % [Add any custom attributes to the interface here] off begin
	// % protected region % [Add any custom attributes to the interface here] end
}

// % protected region % [Customise your entity metadata here] off begin
@entity('StudentsEntityFormTileEntity', 'Students Entity Form Tile')
// % protected region % [Customise your entity metadata here] end
export default class StudentsEntityFormTileEntity extends Model implements IStudentsEntityFormTileEntityAttributes {
	...
	@CRUD({
		...
		formTileFilterFn: (option) => option.formModel === 'StudentsEntity',
	...
	public form: Models.StudentsEntity;

	// % protected region % [Add any custom attributes to the model here] off begin
	// % protected region % [Add any custom attributes to the model here] end

	// eslint-disable-next-line @typescript-eslint/no-useless-constructor
	constructor(attributes?: Partial<IStudentsEntityFormTileEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IStudentsEntityFormTileEntityAttributes>) {
		...
		if (attributes) {
			...
			if (attributes.form !== undefined) {
				if (attributes.form === null) {
					...
					if (attributes.form instanceof Models.StudentsEntity) {
						this.form = attributes.form;
						this.formId = attributes.form.id;
					} else {
						this.form = new Models.StudentsEntity(attributes.form);
...
CRUD(createdAttr)(StudentsEntityFormTileEntity.prototype, 'created');
CRUD(modifiedAttr)(StudentsEntityFormTileEntity.prototype, 'modified');
