...
import { VisitorsAddressSubmission } from 'Models/Security/Acl/VisitorsAddressSubmission';
import { StaffAddressSubmission } from 'Models/Security/Acl/StaffAddressSubmission';
...
export interface IAddressSubmissionEntityAttributes extends IModelAttributes, SubmissionEntityData {
...
@entity('AddressSubmissionEntity', 'Address Submission')
// % protected region % [Customise your entity metadata here] end
export default class AddressSubmissionEntity extends Model implements IAddressSubmissionEntityAttributes {
	...
	@CRUD({
		...
		displayFunction: (attr, that) => (that as AddressSubmissionEntity).formVersion.version.toString(),
		onAfterChange: (model) => {
	...
	constructor(attributes?: Partial<IAddressSubmissionEntityAttributes>) {
	 ...
	 */
	@action
	public assignAttributes(attributes?: Partial<IAddressSubmissionEntityAttributes>) {
...
CRUD(createdAttr)(AddressSubmissionEntity.prototype, 'created');
CRUD(modifiedAttr)(AddressSubmissionEntity.prototype, 'modified');
