...
@observer
export default class AttributeFormData<T extends Model> extends React.Component<IAttributeFormDataProps<T>>{
	public render() {
		const { model, options, className, isReadonly } = this.props;
