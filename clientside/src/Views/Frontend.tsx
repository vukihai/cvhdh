					...
					// % protected region % [Modify Frontend] end
						...
						<>
							<Switch>
								...
								{
								// % protected region % [customize the ListStudent public routes] off begin
								}
								<Route path={"/liststudent"} component={Pages.ListStudentPage} />
								{
								// % protected region % [customize the ListStudent public routes] end
								}
								{
								// % protected region % [customize the FormEditStudent public routes] off begin
								}
								<Route path={"/formeditstudent"} component={Pages.FormEditStudentPage} />
								{
								// % protected region % [customize the FormEditStudent public routes] end
								}
								{
								// % protected region % [customize the EditArchivement public routes] off begin
								}
								<Route path={"/editarchivement"} component={Pages.EditArchivementPage} />
								{
								// % protected region % [customize the EditArchivement public routes] end
								}
								{
								// % protected region % [customize the MainMenu public routes] off begin
								}
								<Route path={"/mainmenu"} component={Pages.MainMenuPage} />
								<Redirect exact={true} from={`/`} to={`${path}/mainmenu`} />
								{
								// % protected region % [customize the MainMenu public routes] end
								}
