...
export function getFrontendNavLinks(pageProps: RouteComponentProps): ILink[][] {
	...
	return [
		...
		[
			...
			{label: "List student", path: '/liststudent', icon: "files", iconPos: 'icon-left'},
			{label: "Form edit student", path: '/formeditstudent', icon: "files", iconPos: 'icon-left'},
			{label: "Edit archivement", path: '/editarchivement', icon: "files", iconPos: 'icon-left'},
			{label: "Main menu", path: '/mainmenu', icon: "files", iconPos: 'icon-left'},
