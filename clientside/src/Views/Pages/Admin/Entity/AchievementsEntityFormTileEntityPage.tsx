...
@observer
export default class AchievementsEntityFormTileEntityPage extends React.Component<RouteComponentProps> {
	...
	public render() {
		...
		contents = (
			<PageWrapper {...this.props}>
				<EntityCRUD
					modelType={Models.AchievementsEntityFormTileEntity}
					{...this.props}
				/>
			</PageWrapper>
		);
		...
		return (
			<SecuredPage groups={["Super Administrators", "Visitors","Staff"]}>
				{contents}
			</SecuredPage>
		);
	}
