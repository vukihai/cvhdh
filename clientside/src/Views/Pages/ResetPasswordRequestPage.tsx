			...
			<div className="body-content">
				<form className="reset-password" onSubmit={this.onResetPasswordClicked}>
					...
					<ButtonGroup alignment={Alignment.HORIZONTAL} className="reset-pwd-buttons">
						<Button className="request-pwd btn--primary" type='submit' display={Display.Solid} sizes={Sizes.Medium} buttonProps={{ id: "reset_password" }}>Reset Password</Button>
						<Button className="cancel-reset-pwd" display={Display.Solid} sizes={Sizes.Medium} colors={Colors.Secondary} buttonProps={{ id: "cancel_reset_pwd" }} onClick={this.onCancelResetClicked}>Cancel</Button>
					</ButtonGroup>
				</form>
			</div>
		);
