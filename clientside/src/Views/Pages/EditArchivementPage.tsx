...
import { AchievementsEntity } from 'Models/Entities';
...
export interface EditArchivementPageProps extends RouteComponentProps {
...
class EditArchivementPage extends React.Component<EditArchivementPageProps> {
		...
		let contents = (
			<SecuredPage>
				...
				<div className="body-content">
					...
					<p>
						this page use to edit archivement of student
					</p>
					<FormSubmissionTile
						modelType={AchievementsEntity}
						tileId="6222cf66-2a75-4abf-bef4-e067f15dbdfe"
						// % protected region % [Add props to form component 6222cf66-2a75-4abf-bef4-e067f15dbdfe here] off begin
						// % protected region % [Add props to form component 6222cf66-2a75-4abf-bef4-e067f15dbdfe here] end
					/>
				</div>
			</SecuredPage>
		);
...
export default EditArchivementPage;
